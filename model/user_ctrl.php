...
function parse_raw_http_request(array &$a_data){
 ...
 function get_user($conn){
  ...
  // table name의 전체 데이터를 condition 조건에 따라 조회하며, cloumn name 기준 역순으로 나열한다.
 ...
 function patch_user($conn){
  ...
  // // 업데이트 구문 : UPDATE [table name] SET [update column] = [pdate value] WHERE [condition]
 ...
 function del_user($conn){
  ...
  // 삭제 구문 : DELETE FROM [table name] WHERE [cidition]
